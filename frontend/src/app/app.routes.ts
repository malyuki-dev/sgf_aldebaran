    ...
    children: [
      ...
      { path: 'quadro-tarefas', component: QuadroStatusComponent },
      {
        ...
        children: [
          ...
          { path: 'filiais', loadComponent: () => import('./pages/admin/estrutura-filiais/tabs/filiais/filiais.component').then(m => m.FiliaisComponent) },
          { path: 'categorias', loadComponent: () => import('./pages/admin/estrutura-filiais/tabs/categorias/categorias-fila.component').then(m => m.CategoriasFilaComponent) },
          { path: 'guiches', loadComponent: () => import('./pages/admin/estrutura-filiais/tabs/guiches/guiches.component').then(m => m.GuichesComponent) },
          { path: 'regras', loadComponent: () => import('./pages/admin/estrutura-filiais/tabs/regras/regras-fila.component').then(m => m.RegrasFilaComponent) },
        ]
      },
      {
        path: 'cadastros',
